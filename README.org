...
This repository is for tracking configuration files for personal GNU Guix systems. It is based on [[https://git.sr.ht/~abcdw/rde][rde]] configuration framework and by default depends on Emacs (+evil-collection) and Sway window manager along other Wayland applications.
...
|------------+--------------------+-----------------------------------------------+----------------------------------------------------|
| box        | Minisforum HX90    | [[file:src/configs/hosts/box.scm][box]]       | Main machine at home, runs full Guix system        |
| mintsystem | HP laptop          | [[file:src/configs/hosts/mintsystem.scm][mintsystem]] | HP laptop, runs home environment via Guix          |
|------------+--------------------+-----------------------------------------------+----------------------------------------------------|
