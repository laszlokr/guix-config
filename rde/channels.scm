(list
 ...
 ;; sing-box lives here -- not packaged in guix or nonguix.  Re-added for
 ;; that reason alone; see doc/reform-guix-desktop.md for why it was
 ;; dropped in the first place ("no longer used").
 (channel
  (name 'rosenthal)
